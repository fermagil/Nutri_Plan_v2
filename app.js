        ...
        const data = {
            ...
            medidas: {
                ...
                parametros_bioquimicos: {
                    ...
                    colesterolTotal: parseFloat(document.getElementById('colesterol-total')?.textContent) || null,
                    ...
                    glucosa_ayunas: parseFloat(document.getElementById('glucosa-ayunas')?.textContent) || null,
                    ...
                    ast: parseFloat(document.getElementById('ast')?.textContent) || null,
                    ...
                    cortisol: parseFloat(document.getElementById('cortisol')?.textContent) || null,
                    cortisolSource: document.getElementById('cortisol-source')?.textContent || null,
                    testosteronaSource: document.getElementById('cortisol-source')?.textContent || null,
                    ...
                    fosfatasa: parseFloat(document.getElementById('fosfatasa-alcalina')?.textContent) || null,
                    fosfatasaSource: document.getElementById('fosfatasa-alcalina-source')?.textContent || null,
                    creatinina: parseFloat(document.getElementById('creatinina')?.textContent) || null,
                    creatininaSource: document.getElementById('creatinina-source')?.textContent || null,
                    bun: parseFloat(document.getElementById('bun')?.textContent) || null,
...
async function cargarDatosToma(clienteId, tomaId) {
    ...
    'colesterolTotal': { id: 'colesterol-total', unit: '', source: 'medidas.parametros_bioquimicos.colesterol_total', format: (v) => typeof v === 'number' && !isNaN(v) ? v.toFixed(0) : (typeof v === 'string' && !isNaN(parseFloat(v)) ? parseFloat(v).toFixed(0) : '---') },
    ...
    'glucosaAyunas': { id: 'glucosa-ayunas', unit: '', source: 'medidas.parametros_bioquimicos.glucosa_ayunas', format: (v) => typeof v === 'number' && !isNaN(v) ? v.toFixed(0) : (typeof v === 'string' && !isNaN(parseFloat(v)) ? parseFloat(v).toFixed(0) : '---') },
    ...
    'tsh': { id: 'result-tsh', unit: '', source: 'medidas.parametros_bioquimicos.tsh', format: (v) => typeof v === 'number' && !isNaN(v) ? v.toFixed(2) : (typeof v === 'string' && !isNaN(parseFloat(v)) ? parseFloat(v).toFixed(2) : '---') },
     'ast': { id: 'ast', unit: '', source: 'medidas.parametros_bioquimicos.ast', format: (v) => typeof v === 'number' && !isNaN(v) ? v.toFixed(2) : (typeof v === 'string' && !isNaN(parseFloat(v)) ? parseFloat(v).toFixed(2) : '---') },
     'cortisol': { id: 'cortisol', unit: '', source: 'medidas.parametros_bioquimicos.cortisol', format: (v) => typeof v === 'number' && !isNaN(v) ? v.toFixed(1) : (typeof v === 'string' && !isNaN(parseFloat(v)) ? parseFloat(v).toFixed(1) : '---') },
    ...
    'fosfatasa': { id: 'fosfatasa-alcalina', unit: '', source: 'medidas.parametros_bioquimicos.fosfatasa', format: (v) => typeof v === 'number' && !isNaN(v) ? v.toFixed(1) : (typeof v === 'string' && !isNaN(parseFloat(v)) ? parseFloat(v).toFixed(1) : '---') },
     'creatinina': { id: 'creatinina', unit: '', source: 'medidas.parametros_bioquimicos.creatinina', format: (v) => typeof v === 'number' && !isNaN(v) ? v.toFixed(1) : (typeof v === 'string' && !isNaN(parseFloat(v)) ? parseFloat(v).toFixed(1) : '---') },
     'bun': { id: 'bun', unit: '', source: 'medidas.parametros_bioquimicos.bun', format: (v) => typeof v === 'number' && !isNaN(v) ? v.toFixed(1) : (typeof v === 'string' && !isNaN(parseFloat(v)) ? parseFloat(v).toFixed(1) : '---') },       
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const fields = [
        ...
        { input: 'colesterol-total', result: 'colesterol-total', source: 'colesterol-total-source', label: 'Colesterol Total', unit: 'mg/dL', range: [50, 400] },
        ...
        { input: 'glucosa-ayunas', result: 'glucosa-ayunas', source: 'glucosa-ayunas-source', label: 'Glucosa en ayunas', unit: 'mg/dL', range: [40, 300] },
        ...
        { input: 'bun', result: 'bun', source: 'bun-source', label: 'BUN', unit: 'mg/dL', range: [7, 25] },
        ...
        { input: 'cortisol', result: 'cortisol', source: 'cortisol-source', label: 'Cortisol', unit: 'µg/dL', range: [5, 25] },
        { input: 'vitamina-d', result: 'result-vitamina-d', source: 'vitamina-d-source', label: 'Vitamina D', unit: 'ng/mL', range: [5, 200] },
        { input: 'fosfatasa-alcalina', result: 'fosfatasa-alcalina', source: 'fosfatasa-alcalina-source', label: 'Fosfatasa Alcalina', unit: 'U/L', range: [20, 140] },
        { input: 'ast', result: 'ast', source: 'ast-source', label: 'AST', unit: 'U/L', range: [5, 200] },
