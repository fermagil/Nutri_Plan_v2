    ...
    if (edad < 5) {
        ...
        const generateExplanationsAndSuggestions = (data, results, bodyCompResults) => {
			...
			if (!isNaN(results.icc)) {
				...
				if (gender === 'masculino') {
					if (results.icc < 0.78) {
						content += '<p>ICC < 0.78 (tipo ginoide): Bajo riesgo cardiovascular. ¡Buen indicador de salud! </p>';
